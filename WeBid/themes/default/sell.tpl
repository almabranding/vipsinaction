...
<!-- IF PAGE eq 0 -->
	...
	<!-- IF CAT_LIST2 ne '' -->
							{CAT_LIST2}<br>
	<!-- ENDIF -->
							[<a href="{ASSLURL}select_category.php?change=yes">{L_5113}</a>]
						</td>
					</tr>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
	...
	<!-- IF B_GALLERY -->
					<tr>
						...
						<td valign="top" class="rightpan">
							<h3>{L_663}</h3>
							<p>{MAXPICS}</p>
							[<a href="{ASSLURL}upldgallery.php" alt="gallery" class="new-window">{L_677}</a>]
	...
	<!-- ENDIF -->
					<tr class="dutchhide">
						...
						<td class="rightpan">
							...
							{CURRENCY}&nbsp;&nbsp;(<a href="{ASSLURL}converter.php" alt="converter" class="new-window">{L_5010}</a>) </td>
					</tr>
	<!-- IF B_BN_ONLY -->
					<tr class="dutchhide">
						<td align="right" width="25%" valign="top" class="leftpan">
	...
	<!-- ENDIF -->
					...
					<tr>
						...
						<td class="rightpan">
							...
							{CURRENCY}&nbsp;&nbsp;(<a href="{ASSLURL}converter.php" alt="converter" class="new-window">{L_5010}</a>)
						</td>
					</tr>
