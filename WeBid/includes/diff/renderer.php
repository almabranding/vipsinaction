...
<caption>
	<span class="unmodified">&nbsp;</span> ' . 'LINE_UNMODIFIED' . '
	<span class="added">&nbsp;</span> ' . 'LINE_ADDED' . '
	<span class="modified">&nbsp;</span> ' . 'LINE_MODIFIED' . '
	<span class="removed">&nbsp;</span> ' . 'LINE_REMOVED' . '
</caption>
<tbody>
';
		...
		{
			$output .= '<tr><th colspan="2">' . 'NO_VISIBLE_CHANGES' . '</th></tr>';
		}
		else
		{
			...
			{
				$output .= '<tr><th>' . 'LINE' . ' ' . $header['oldline'] . '</th><th>' . 'LINE' . ' ' . $header['newline'] . '</th></tr>';
